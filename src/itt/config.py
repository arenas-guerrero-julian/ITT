...
class Config(ConfigParser):
    ...
    def get_mongo_url(self, source_section):
        return self.get(source_section, MONGO_URL)

    def has_database_url(self, source_section):
        return self.has_option(source_section, DATABASE_URL)

    def has_mongo_url(self, source_section):
        return self.has_option(source_section, MONGO_URL)

    def get_query(self):
        return self.get(CONFIGURATION_SECTION, 'query_path')
