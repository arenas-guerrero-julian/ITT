...
def _parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Copyright © 2020-2024 Julián Arenas-Guerrero",
        allow_abbrev=False,
        prog='python3 -m itt',
    ...
    parser.add_argument('query', help='path to sparql query file')
    parser.add_argument('-v', '--version', action='version',
                        version=f'ITT {__version__} | Copyright © 2020-2024 Julián Arenas-Guerrero')
